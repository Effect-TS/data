...
```ts
export declare const Apply: _apply.Apply<ListTypeLambda>
```
...
```ts
export declare const FromIdentity: _fromIdentity.FromIdentity<ListTypeLambda>
```
...
```ts
export declare const Functor: _functor.Functor<ListTypeLambda>
```
