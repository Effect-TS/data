 ...
 * @category models
 */
export interface Cons<A> extends List.Variance<A>, Iterable<A>, Equal.Equal, Withable<List<A>> {
  readonly _tag: "Cons"
  readonly head: A
 ...
 * @category models
 */
export interface Nil<A> extends List.Variance<A>, Iterable<A>, Equal.Equal, Withable<List<A>> {
  readonly _tag: "Nil"
}
