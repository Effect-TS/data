...
export const ListTypeId: L_.ListTypeId = Symbol.for("@fp-ts/data/List") as L_.ListTypeId
...
export class Cons<A> implements Iterable<A>, L_.Cons<A> {
  readonly _tag = "Cons"
  readonly _A: (_: never) => A = (_) => _
  readonly _typeId: L_.ListTypeId = ListTypeId
...
export class Nil<A> implements Iterable<A>, L_.Nil<A> {
  readonly _tag = "Nil"
  readonly _A: (_: never) => A = (_) => _
  readonly _typeId: L_.ListTypeId = ListTypeId;
