 ...
 * @category models
 */
export interface Tag<Identifier, Service> extends Withable<Tag<Identifier, Service>> {
  readonly _tag: "Tag"
...
export interface TracedTag<Identifier, Service>
  extends Withable<Tag<Identifier, Service> | TracedTag<Identifier, Service>>
{
 ...
 * @category models
 */
export interface Context<Services> extends Equal, Withable<Context<Services>> {
  readonly _id: TypeId
